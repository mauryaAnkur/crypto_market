...
class OrderVolume extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    OrderVolumeController.to.getOrderVolume(coinData: coinData, listedCoinOrderBookUrl: listedCoinOrderBookUrl);

    final height = MediaQuery.of(context).size.height;
    double mediaQuery = MediaQuery.of(context).size.width / 2.2;
    return GetBuilder<OrderVolumeController>(
        builder: (_) {
          return Column(
            children: [
                ...
                children: <Widget>[
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      primary: false,
                      padding: EdgeInsets.zero,
                      itemCount: OrderVolumeController.to.coinOrderVolumeBuyList.length < 20 ? OrderVolumeController.to.coinOrderVolumeBuyList.length : 20,
                      itemBuilder: (BuildContext ctx, int i) {
                        return _buyAmount(context, mediaQuery, OrderVolumeController.to.coinOrderVolumeBuyList[i]);
                      },
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      primary: false,
                      padding: EdgeInsets.zero,
                      itemCount: OrderVolumeController.to.coinOrderVolumeSellList.length < 20 ? OrderVolumeController.to.coinOrderVolumeSellList.length : 20,
                      itemBuilder: (BuildContext ctx, int i) {
                        return _amountSell(context, mediaQuery, OrderVolumeController.to.coinOrderVolumeSellList[i]);
                      },
                    ),
                  ),
                ],
                ...
                child: SizedBox(
                  ...
                  child: Text(
                    coinData.coinPairWith == "INR"
                        ...
                        : double.parse(item.price).toStringAsFixed(coinData.coinDecimalCurrency),
                    maxLines: 1,
                    textAlign: TextAlign.end,
                    style: TextStyle(
                        color: Colors.green[600],
